...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Member - ARENALO')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    {{-- Style mengikuti admin agar konsisten --}}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarMember">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a
                        class="nav-link {{ request()->routeIs('member.home') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a
                        class="nav-link {{ request()->routeIs('member.fields.*') ? 'active' : '' }}"
                        href="{{ route('member.fields.index') }}"
                    >
                        Lapangan
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a
                        class="nav-link {{ request()->routeIs('member.bookings.*') ? 'active' : '' }}"
